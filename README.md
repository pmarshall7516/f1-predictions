...
Data comes from [FastF1](https://docs.fastf1.dev/) (2019–2025). Train / val / test splits are chronological: **2019–2023 / 2024 / 2025**.

Implementation rationale: [`docs/baseline-notes.md`](docs/baseline-notes.md). Modeling and plots: [`baseline-notebook.ipynb`](baseline-notebook.ipynb).
